...
class ShowTableBoard extends Component {
    ...
    onEditSubmit=(id)=>{
        ...
        <Link to={{pathname:`/admin/edit/${id}`}}/>
    }
    render() {
                                    ...
                                    <tbody>
                                        {boards.map((board, index) =>
                                            <tr>
                                                ...
                                                <td >{board.role.bureau}</td>
                                                <td >{board.role.active_applications}</td>
                                                <td >{board.phone_number}</td>
                                                <td ><button type="button"  class="btn btn-block btn-outline-primary btn-xs">Details</button></td>
                                                <td ><button type="button" onClick={this.onEditSubmit.bind(this,board.id)} class="btn btn-block btn-outline-warning btn-xs">Complain</button></td>
